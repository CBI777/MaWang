...
public class MonsterAI__ElitePhantom : MonsterController
{
    [SerializeField]
    private int readyRange = 10;
    ...
    { new Vector3Int(0, 0, 0), new Vector3Int(1, 0, 0), new Vector3Int(0, 1, 0), new Vector3Int(-1, 0, 0), new Vector3Int(0, -1, 0),
      ...
      new Vector3Int(1, 2, 0), new Vector3Int(2, 1, 0), new Vector3Int(2, -1, 0), new Vector3Int(1, -2, 0), new Vector3Int(-1, -2, 0),
      new Vector3Int(-2, -1, 0), new Vector3Int(-2, 1, 0), new Vector3Int(-1, 2, 0)
    };
    ...
    IEnumerator PhantomAttack()
    {
        if (AttackFlag)
        {
            ...
            gameObject.GetComponentInParent<SpawnManager>().AttackPlayer(playerTarget,
                attackRange, gameObject.GetComponent<CharacterBase>().getStr(), "Explosion_Darkness", "Magic3");
            yield return new WaitForFixedUpdate();
            this.ActFlag = true;
